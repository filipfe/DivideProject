...
export default function ServiceRef({ title, desc, decorator }: Service) {
  ...
  return (
    <div className="flex flex-col gap-4 pt-20 service relative">
      ...
      <p className="leading-relaxed service-p bg-clip-text text-transparent font-medium text-sm px-8 !opacity-80">
        {desc}
      </p>
      <div className="service-back max-w-[85%] pt-6 pr-6 mt-4">
